                        ...
                        if(resProvider.attributeList![0].active && resProvider.attributeList![0].variants.isNotEmpty)
                          GridView.builder(
                              ...
                              itemBuilder: (context, index){
                                ...
                                print("===ImageURl===>>${resProvider.withColor[index].colorImage?.imageName ?? ''}");
                                return Padding(
                                    ...
                                    child: Stack(children: [
                                      DottedBorder(
                                          ...
                                          child: ClipRRect(
                                              borderRadius: BorderRadius.circular(Dimensions.paddingSizeSmall),
                                              child: (_update)?
                                              CustomImageWidget(image: "${Provider.of<SplashController>(context, listen: false).configModel?.baseUrls?.productImageUrl}/${resProvider.withColor[index].colorImage?.imageName ?? ""}",
