...
class AddProductService implements AddProductServiceInterface{
 ...
 AddProductService({required this.shopRepoInterface});
  ...
  @override
  Future addProduct(Product product, AddProductModel addProduct, Map<String, dynamic> attributes, List<String?>? productImages, String? thumbnail, String? metaImage, bool isAdd, bool isActiveColor, List<ColorImage> colorImageObject, List<String?> tags, String? digitalFileReady) async{
    return await shopRepoInterface.addProduct(product, addProduct, attributes, productImages, thumbnail, metaImage, isAdd, isActiveColor, colorImageObject, tags, digitalFileReady);
  }
