...
class ItemCartWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    String baseUrl = '${Provider.of<SplashController>(context, listen: false).configModel!.baseUrls!.productThumbnailUrl}';
    return Padding(
                    ...
                    children: [
                      Container(height: Dimensions.productImageSize,
                          ...
                          child: ClipRRect(
                            ...
                            child: CustomImageWidget(image: '$baseUrl/${cartModel!.product!.thumbnail}',
