...
class CookiesWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final double padding = (width - 20) / 2;
                    ...
                    child: SizedBox(width: MediaQuery.of(context).size.width, child: Row(
                      ...
                      children: [
                        Padding(
                          ...
                          CustomImageWidget(
                            height: 35, width: 35,
                            image: '${Provider.of<SplashController>(context,listen: false).baseUrls!.productThumbnailUrl}${productController.stockLimitStatus?.product?.thumbnail}')
                          : Image.asset(
                            height: 32, width: 32,
                        ...
                        Expanded(
                          child: Column(crossAxisAlignment: CrossAxisAlignment.start,children: [
                            ...
                            Text(
                              ...
                              ((productController.stockLimitStatus!.productCount! - 1).toString() ?? '0') + getTranslated('more_products_have_low_stock', context)! :
