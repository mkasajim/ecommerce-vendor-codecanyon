            ...
            Padding(padding: const EdgeInsets.fromLTRB( Dimensions.paddingSizeDefault,
              ...
              child: Row(children: [
                  ...
                  Expanded(child: TitleRowWidget(color: Colors.white, title: '${getTranslated('most_popular_products', context)}',
                        isPopular: true,
                        onTap: (productList != null && productList.length > 4) ? () => Navigator.push(context, MaterialPageRoute(builder: (_) => const ProductListScreen(isPopular: true, title: 'most_popular_products'))) : null),
                  ),
                ],
              ),
            ):const SizedBox(),
