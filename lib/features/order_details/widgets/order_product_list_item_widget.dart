              ...
              return Row(mainAxisAlignment: MainAxisAlignment.end,crossAxisAlignment: CrossAxisAlignment.end, children: [
                  InkWell(onTap : () async {
                      if(widget.orderDetailsModel!.productDetails!.digitalProductType == 'ready_after_sell' &&
                        ...
                        _launchUrl(Uri.parse('${Provider.of<SplashController>(context, listen: false).baseUrls!.digitalProductUrl}/${widget.orderDetailsModel!.digitalFileAfterSell}')):
                        _launchUrl(Uri.parse('${Provider.of<SplashController>(context, listen: false).baseUrls!.digitalProductUrl}/${widget.orderDetailsModel!.productDetails!.digitalFileReady}'));
                      }
